package com.kotlin.zmvvm.ui.navigation
 ...
 * @author 13718
 */
public class NavigationAdapter(var layoutId: Int, listData: MutableList<NavgationBean>?) :
    BaseQuickAdapter<NavgationBean, BaseViewHolder>(layoutId, listData) {
